			...
			onleaf = function(node, depth)
				...
				for cfg in project.eachconfig(prj) do
					...
					if #filecfg.buildcommands ~= 0 or filecfg.buildmessage then
						...
						_p(3, '<Option compiler="%s" use="1" buildCommand="%s" />', m.getcompilername(cfg), os.translateCommandsAndPaths(buildmessage .. commands .. compile, cfg.project.basedir, cfg.project.location))
						break
					end
				end
